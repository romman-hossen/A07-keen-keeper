...
const DisplayFriends = ({ friend }) => {
  ...
  return (
    <Link
      to={`/friendDetails/${id}`}
      className="p-6 flex flex-col items-center bg-white space-y-2 rounded-lg shadow border border-transparent
  transition-all duration-300
  hover:-translate-y-2 hover:shadow-xl hover:border-green-600
  hover:scale-055 hover:rotate-1 hover:animate-[wiggle_0.4s_ease-in-out_1]"
    >
      <div>
