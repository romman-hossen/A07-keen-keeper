...
const NoItem = () => {
    return (
     <div className="min-h-[50vh] bg-white rounded-xl shadow-sm border border-gray-100 text-center flex flex-col justify-center items-center px-3 mx-1 sm:mx-0.5">
